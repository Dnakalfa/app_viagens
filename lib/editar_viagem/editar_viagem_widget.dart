      ...
      builder: (context, snapshot) {
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
            appBar: AppBar(
              backgroundColor: const Color(0xFF3D3A44),
                                    ...
                                    children: [
                                      ...
                                      TextFormField(
                                        controller:
                                          ...
                                          text: editarViagemViagensRecord
                                              .descricao,
                                        ),
                                        ...
                                        decoration: InputDecoration(
                                          labelText: editarViagemViagensRecord
                                              .descricao,
                                          labelStyle:
                                      ...
                                      TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          alignLabelWithHint: true,
                                          hintText:
                                              'De 1 a 5 qual a vontade de ir a este local.',
                                          hintStyle:
                                              FlutterFlowTheme.of(context)
                                                  .labelMedium
                                                  .override(
                                            ...
                                            onPressed: () async {
                                              await widget.viagemRef!.update(
                                                ...
                                                vontade: int.tryParse(_model
                                                    .vontadeTextController
                                                    .text),
                                                investimento:
                                                    _model.investimentoValue,
                                              ));
                                              await showDialog(
                                                context: context,
                                                        ...
                                                        builder:
                                                          ...
                                                          return AlertDialog(
                                                            title:
                                                                const Text('Atenção'),
                                                            content: const Text(
                                                                'Você realmente quer deletar o arquivo?'),
                                                            actions: [
                                                              TextButton(
                                                                onPressed: () =>
                                                                    Navigator.pop(
